...
class UsersController extends BaseController
{
    ...
    {
        try {
            $manager = $this->getDI()->get('core_user_manager');//Get the user manager
            $page    = $this->request->getQuery('p', 'int', 0);//Get the page for possible pagination

            //Ask the manager to perform a request for all the user through our API
