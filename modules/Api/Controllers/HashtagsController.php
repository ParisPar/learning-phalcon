...
class HashtagsController extends BaseController
{
    ...
    public function listAction()
    {
        try {
            ...
            $st_output = $manager->restGet([], [], $page);//Returns an array of records with pagination
    ...
    public function updateAction($id)
    {
        try {
            ...
            //$data is an array. The actual record data is inside $data[0]
            if (count($data[0]) == 0) {
            ...
            $result = $manager->restUpdate($data);//Returns the updated record
