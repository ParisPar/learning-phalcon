...
<form class="form-signin" method="post" action="">
	{# The ~ operator is a concatenation. content() doesn't include the flashSession component so we add it ourselves #}
	...
	<div class="checkbox">
		<label>{{ signinForm.render('remember') }}Remember Me</label>
	</div>
